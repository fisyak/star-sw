...
namespace StdEdxPull {
  Double_t EvalPred(Double_t betagamma, UChar_t fit = 0, Int_t charge=1, Double_t mass = 0, Double_t *sigmaCor = 0);
  Double_t EvalDeV(Double_t dEdx, Double_t betagamma, UChar_t fit = 0, Int_t charge=1, Double_t mass = 0, Double_t *sigmaCor = 0);
  Double_t Eval(Double_t dEdx, Double_t dEdxError, Double_t betagamma, UChar_t fit = 0, Int_t charge=1, Double_t mass = 0);
