...
void THelixTrack::Test5()
{
  ...
  for (int ip=0;ip<3;ip++) {
    ...
    THelixTrack th2(pars[ip][1],pars[ip][1]+3,pars[ip][1][6]); 
    th1.Move(-50);
    th2.Move(-50);
    double s2;
...
//        if(fabs(dip)>1) continue;
        ...
        trak.Step(200.,spotSurf,4, xIde,pIde,closePoint);
...
/***************************************************************************
 *
 * $Id: THelixTrack.cxx,v 1.82 2020/03/09 17:56:16 perev Exp $
 *
 ...
 * Revision 1.82  2020/03/09 17:56:16  perev
