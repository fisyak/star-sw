...
//histos
  ...
  static const int nHistoPartParam3D = 17; ///< Number of 3D histograms: y-pt-M, y-mt-M, b-pt-M, b-y-M, b-mt-M, ct-pt-M, dalitz1-4, (K0s olnly: y-phi-M1GeV for pT > 1 GeV/c, y-pt-dM1GeV, y-phi-M, y-pt-dM), zRhoPhi (for gamma only)
