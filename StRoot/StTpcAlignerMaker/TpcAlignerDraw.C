...
/* mX(1), A( 3,1), ds, */ {"dnYdaS",       "nZS    => aS", 110,-1.100, 1.100,100,-0.010, 0.010}, // 4
/* mX(1), A( 5,1), ds, */ {"dnYdgS",       "-nXS   => gS", 110,-1.100, 1.100,100,-0.010, 0.010}, // 5
/* mX(1), A( 9,1), dw, */ {"dnYdaW",       "nZU    => aW", 110,-1.100, 1.100,100,-0.010, 0.010}, // 6
/* mX(1), A(11,1), dw, */ {"dnYdgW",       "-nXU   => gW", 110,-1.100, 1.100,100,-0.010, 0.010}, // 7
/* mX(2), A( 3,2), ds, */ {"dnZdaS",       "-nYS   => aS", 110,-1.100, 1.100,100,-0.010, 0.010}, // 8
/* mX(2), A( 4,2), ds, */ {"dnZdbS",       "-nXS   => bS", 110,-1.100, 1.100,100,-0.010, 0.010}, // 9
/* mX(2), A( 9,2), dw, */ {"dnZdaW",       "-nYU   => aW", 110,-1.100, 1.100,100,-0.010, 0.010}, //10
/* mX(2), A(10,2), dw, */ {"dnZdbW",       "-nXU   => bW", 110,-1.100, 1.100,100,-0.010, 0.010}, //11

/* mX(3), A( 4,3), ds, */ {"dXdbS",        "-ZS    => bS", 100,-250.0, 10.00,100,-5.000, 5.000}, //12
/* mX(3), A( 5,3), ds, */ {"dXdgS",        "YS     => gS",  65, 50.00,180.00,100,-5.000, 5.000}, //13
/* mX(3), A(10,3), dw, */ {"dXdbW",        "-ZU    => bW", 100,-250.0, 10.00,100,-5.000, 5.000}, //14
/* mX(3), A(11,3), dw, */ {"dXdgW",        "YU     => gW",  65, 50.00,180.00,100,-5.000, 5.000}, //15
