...
const  PlotName_t plotNameWS[NwsPlots] = {// plots for drift
  {"dXdyS",       "dX     versus dX/dyS   [1, 2]  => dyS",        110,-1.500, 1.500,500,   -1.5,  1.5}, // 0
  {"dXdaS",       "dX     versus dX/daS   [1, 4]  => daS",        110,-300.0, 300.0,500,   -1.5,  1.5}, // 1
  {"dXdbS",       "dX     versus dX/dbS   [1, 5]  => dbS",        110,-100.0, 500.0,500,   -1.5,  1.5}, // 2
  {"dXdgS",       "dX     versus dX/dgS   [1, 6]  => dgS",        110,-200.0, 280.0,500,   -1.5,  1.5}, // 3
  {"dXdxW",       "dX     versus dX/dxW   [1, 7]  => dxW",        110,-1.400, 1.400,500,   -1.5,  1.5}, // 4
  {"dXdyW",       "dX     versus dX/dyW   [1, 8]  => dyW",        110,-1.600, 1.600,500,   -1.5,  1.5}, // 5
  {"dXdaW",       "dX     versus dX/daW   [1,10]  => daW",        110,-340.0, 340.0,500,   -1.5,  1.5}, // 6
  {"dXdbW",       "dX     versus dX/dbW   [1,11]  => dbW",        110,-300.0, 240.0,500,   -1.5,  1.5}, // 7
  {"dXdgW",       "dX     versus dX/dgW   [1,12]  => dgW",        110,-280.0, 280.0,500,   -1.5,  1.5}, // 8
  {"dZdyS",       "dZ     versus dZ/dyS   [2, 2]  => dyS",        110,-1.500, 1.500,500,   -1.0,  1.0}, // 9
  {"dZdaS",       "dZ     versus dZ/daS   [2, 4]  => daS",        110,-320.0, 4100.0,500,   -1.0,  1.0}, //10
  {"dZdbS",       "dZ     versus dZ/dbS   [2, 5]  => dbS",        110,-160.0, 160.0,500,   -1.0,  1.0}, //11
  {"dZdgS",       "dZ     versus dZ/dgS   [2, 6]  => dgS",        110, -40.0,  40.0,500,   -1.0,  1.0}, //12
  {"dZdxW",       "dZ     versus dZ/dxW   [2, 7]  => dxW",        110,-1.200, 0.800,500,   -1.0,  1.0}, //13
  {"dZdyW",       "dZ     versus dZ/dyW   [2, 8]  => dyW",        110,-1.200, 1.200,500,   -1.0,  1.0}, //14
  {"dZdaW",       "dZ     versus dZ/daW   [2,10]  => daW",        110,-420.0, 560.0,500,   -1.0,  1.0}, //15
  {"dZdbW",       "dZ     versus dZ/dbW   [2,11]  => dbW",        110,-300.0, 200.0,500,   -1.0,  1.0}, //16
  {"dZdgW",       "dZ     versus dZ/dgW   [2,12]  => dgW",        110, -40.0,  40.0,500,   -1.0,  1.0}, //17
  {"dnXdbS",      "dnX    versus dnX/dbS  [3, 5]  => dbS",        110,-0.800, 0.800,500,  -0.03, 0.03}, //18
  {"dnXdgS",      "dnX    versus dnX/dgS  [3, 6]  => dgS",        110,   -1.,    1.,500,  -0.03, 0.03}, //19
  {"dnXdaW",      "dnX    versus dnX/daW  [3,10]  => daW",        110,-1.100, 1.100,500,  -0.03, 0.03}, //20
  {"dnXdbW",      "dnX    versus dnX/dbW  [3,11]  => dbW",        110,-1.100, 1.100,500,  -0.03, 0.03}, //21
  ...
  {"dnYdaW",      "dnY    versus dnY/daW  [4,10]  => daW",        110,-0.700, 0.800,500,  -0.03, 0.03}, //25
  {"dnYdbW",      "dnY    versus dnY/dbW  [4,11]  => dbW",        110,-0.600, 0.500,500,  -0.03, 0.03}, //26
  {"dnYdgW",      "dnY    versus dnY/dgW  [4,12]  => dgW",        110,-0.800, 0.800,500,  -0.03, 0.03}, //27
  {"dnZdaS",      "dnZ    versus dnZ/daS  [5, 4]  => daS",        110,-1.000, 1.000,500,  -0.01, 0.01}, //28
