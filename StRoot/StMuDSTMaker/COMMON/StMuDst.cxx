...
// returns pointer to the n-th TClonesArray from the fms arrays
TClonesArray* StMuDst::rhicfArray(Int_t type) { return instance()->rhicfArrays[type]; }
...
StMuRHICfCollection* StMuDst::muRHICfCollection() { return instance()->mMuRHICfCollection; }
...
StRHICfCollection* StMuDst::rhicfCollection() {  return instance()->mRHICfCollection; }
