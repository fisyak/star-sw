...
void StBFChain::SetDbOptions(StMaker *mk){
  ...
  if (GetOption("TFGdbOpt")) {
    const Char_t *TFGTables[] = {"tpcSectorT0offset", "TpcPosition", "TpcHalfPosition", "TpcWheelPosition", "TpcSuperSectorPositionB", "TpcSuperSectorPositionD", "TpcInnerSectorPositionB", "TpcOuterSectorPositionB", 0};
