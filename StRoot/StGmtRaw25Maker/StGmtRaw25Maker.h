...
#ifndef STAR_StGmtRaw25Maker_HH
#define STAR_StGmtRaw25Maker_HH
#include "StMaker.h"
#include "TH1.h"
#include "TH2.h"
#include "TProfile.h"
...
class StGmtRaw25Maker :  public StRTSBaseMaker {
  //omitted assignment operator and copy constructor on purpose
 public:
  StGmtRaw25Maker( const Char_t* name="GmtRaw");
  virtual ~StGmtRaw25Maker() {}
  Int_t Init();
  Int_t InitRun(Int_t runumber);
  Int_t Make();
  virtual const char *GetCVS() const
  {static const char cvs[]="Tag $Name:  $ $Id: StGmtRaw25Maker.h,v 1.1.1.1 2013/09/02 15:01:02 fisyak Exp $ built " __DATE__ " " __TIME__ ; return cvs;}
 private:
