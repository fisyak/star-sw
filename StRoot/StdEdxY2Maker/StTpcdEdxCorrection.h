...
class StTpcdEdxCorrection : public TObject {
 public:
  ...
  enum EOptions : int {
      ...
      kAdcCorrection         =  1,//R  					     
      kAdcCorrectionC        =  2,//R  					     
      kAdcCorrectPrompt      =  3,//P  					     
      kEdge                  =  4,//E   correction near edge of chamber	     
      kAdcCorrectionMDF      =  5,//RMDF  					     
      kAdcCorrection3MDF     =  6,//RMDF  3D  					     
      kAdcCorrection4MDF     =  7,//RMDF  4D  					     
      kAdcCorrection5MDF     =  8,//RMDF +4D  					     
      kAdcCorrection6MDF     =  9,//AdcCorrectionC +4D  & kAdcCorrectPrompt					     
      kTpcdCharge            = 10,//D  					     
      kTpcrCharge            = 11,//D  					     
      kTpcCurrentCorrection  = 12,//      					     
      kTpcSecRowB            = 13,//S  					     
      kTpcSecRowC            = 14,//S  					     
      kTpcRowQ               = 15,//   	 					       	   
      kTpcAccumulatedQ       = 16,//   	 					       	   
      ...
      kzCorrection           = 23,//Z  					     
      ktpcMethaneIn          = 24,//m  					     
      ktpcGasTemperature     = 25,//T  					     
      ktpcWaterOut           = 26,//W   				       	   
      kSpaceCharge           = 27,//C   space charge near the wire	       	   
      kPhiDirection          = 28,//p   correction wrt local interception angle  
      kTanL                  = 29,//p   correction wrt local tan(lambda)  
      kdXCorrection          = 30,//X  					     
      kEtaCorrection         = 31,//Eta  					     
      kEtaCorrectionB        = 32,//EtaB  					     
      kTpcEffectivedX        = 33,//X   Effective pad row height
      kTpcPadTBins           = 34,//d  					     
      kTpcZDC                = 35,//   					     
      kTpcPadMDF             = 36, 
      kTpcPadMDC             = 37,
      ...
      kBadFrac               = 43,
      kTpcLast               = 44,//                                             
      kTpcNoAnodeVGainC      = 45,//   					     
      kTpcLengthCorrection   = 46,//                                             
      kTpcLengthCorrectionMDF= 47,//   					   
      kTpcLengthCorrectionMD2= 48,//   					   
      kTpcLengthCorrectionMDN= 49,//   					   
      kTpcdEdxCor            = 50,//   					   
      kTpcAllCorrections     = 51 //                                             
  };
...
class dEdxY2_t {
 public:
  ...
  Float_t  LengthInTpc; // track length in TPC from the first hit
  Char_t   last[1];
