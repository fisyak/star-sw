...
class StPicoDst {
 ...
 public:
  ...
  StPicoFwdTrack* fwdTrack(Int_t i) { return (StPicoFwdTrack*)picoArrays[StPicoArrays::FwdTrack]->UncheckedAt(i); }
  /// Return pointer to i-th fwd vertex
  StPicoFwdVertex* fwdVertex(Int_t i) { return (StPicoFwdVertex*)picoArrays[StPicoArrays::FwdVertex]->UncheckedAt(i); }
  /// Return pointer to i-th fcs Hit
  StPicoFcsHit* fcsHit(Int_t i) { return (StPicoFcsHit*)picoArrays[StPicoArrays::FcsHit]->UncheckedAt(i); }
  /// Return pointer to i-th fcs Cluster
  StPicoFcsCluster* fcsCluster(Int_t i) { return (StPicoFcsCluster*)picoArrays[StPicoArrays::FcsCluster]->UncheckedAt(i); }
  ...
  UInt_t numberOfFwdTracks() { return picoArrays[StPicoArrays::FwdTrack]->GetEntriesFast(); }
  /// Return number of FcsHits
  UInt_t numberOfFcsHits() { return picoArrays[StPicoArrays::FcsHit]->GetEntriesFast(); }
  /// Return number of FcsClusters
  UInt_t numberOfFcsClusters() { return picoArrays[StPicoArrays::FcsCluster]->GetEntriesFast(); }
