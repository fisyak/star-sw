...
if ($?CMAKE_PREFIX_PATH) setenv EXTRA_OFF "${EXTRA_OFF} -DCMAKE_PREFIX_PATH=${CMAKE_PREFIX_PATH} -DZSTD_INCLUDE_DIR=${CMAKE_PREFIX_PATH}/include -DZSTD_LIBRARIES=${CMAKE_PREFIX_PATH}/lib -DMYSQL_CONFIG_EXECUTABLE=${CMAKE_PREFIX_PATH}/bin"
