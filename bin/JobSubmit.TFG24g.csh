...
#    /gpfs01/star/subsys-tpc/fisyak/STAR/packages/scripts/star-submit ~fisyak/xml/daq.TFG24g.xml
    /net/l402/data/fisyak/STAR/packages/.DEV2/scripts/star-submit  -p bnl_condor_online_CpuModelNumber6X  ~fisyak/xml/daq.TFG24g.xml
#    /gpfs01/star/subsys-tpc/fisyak/STAR/packages/scripts/star-submit -p bnl_condor_production  ~fisyak/xml/daq.TFG24d.xml
  touch Submitted
  cd -
#  if ($countJ >= 40) then 
#	break;
