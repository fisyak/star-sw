...
cd /hlt/cephfs/reco/2023/RF/TFG/Cosmic
# CreateRunDirs.pl
foreach d (`ls -1d 213/24*`)
  cd $d;
...
#  /net/l402/data/fisyak/STAR/packages/.DEV2/scripts/star-submit -p bnl_condor_online_CpuModelNumber6X ~/xml/daq_2023.xml
...
#    root.exe -q -b 'Chain.C+("./*picoDst.root","PicoDst")' >&  Chain.log  &
    root.exe -q -b Chain.C+ >&  Chain.log  &
