...
void ComponentNeBem3d::SetPeriodicityX(const double s) {
  ...
  m_symmetries.Activate(Symmetry::Type::PeriodicX);
  m_symmetries.Deactivate(Symmetry::Type::MirrorX);
  UpdatePeriodicity();
}
...
void ComponentNeBem3d::SetPeriodicityY(const double s) {
  ...
  m_symmetries.Activate(Symmetry::Type::PeriodicY);
  m_symmetries.Deactivate(Symmetry::Type::MirrorY);
  UpdatePeriodicity();
}
...
void ComponentNeBem3d::SetPeriodicityZ(const double s) {
  ...
  m_symmetries.Activate(Symmetry::Type::PeriodicZ);
...
void ComponentNeBem3d::SetMirrorPeriodicityX(const double s) {
  ...
  m_symmetries.Activate(Symmetry::Type::MirrorX);
  UpdatePeriodicity();
}
...
void ComponentNeBem3d::SetMirrorPeriodicityY(const double s) {
  ...
  m_symmetries.Activate(Symmetry::Type::MirrorY);
  UpdatePeriodicity();
}
...
bool ComponentNeBem3d::GetPeriodicityY(double& s) const {
  if (!m_symmetries.Has(Symmetry::Type::PeriodicY) &&
      !m_symmetries.Has(Symmetry::Type::MirrorY)) {
    s = 0.;
    return false;
  }
...
void ComponentNeBem3d::ShiftPanels(std::vector<Panel>& panels) const {
  ...
  // *---------------------------------------------------------------------
  const bool perx = m_symmetries.Has(Symmetry::Type::PeriodicX) ||
                    m_symmetries.Has(Symmetry::Type::MirrorX);
  const bool pery = m_symmetries.Has(Symmetry::Type::PeriodicY) ||
                    m_symmetries.Has(Symmetry::Type::MirrorY);
  const bool perz = m_symmetries.Has(Symmetry::Type::PeriodicZ) ||
                    m_symmetries.Has(Symmetry::Type::MirrorZ);
...
void ComponentNeBem3d::UpdatePeriodicity() {
  for (std::size_t i = 0; i < 3; ++i) {
    ...
    if ((m_symmetries.Has(Symmetry::Type::Periodic) ||
         m_symmetries.Has(Symmetry::Type::Mirror)) &&
        m_periodicLength[i] < Small) {
      std::cerr << m_className << "::UpdatePeriodicity:\n"
