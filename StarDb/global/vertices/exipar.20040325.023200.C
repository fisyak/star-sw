...
// SVT+TPC cuts
  ...
  row.dca_max	 =        0.8; // cut on dca between the two tracks ;
  row.bxi_max	 =        0.8; // cut on impact param. of xi from prim. vertex ;
  row.rv_xi	 =          1; // cut on min. dist. of decay from prim. vertex ;
  row.rv_v0	 =        2.5; // cut on min. dist. of decay from prim. vertex ;
  row.dmass	 =       0.01; // v0 mass cut +/- [dmass] ;
  row.bpn_v0	 =          1; // cut on v0 pion daught. impact param. ;
  row.pchisq	 =          0; // cut on chi^2 probability of vertex fit;
  tableSet->AddAt(&row);
//
// ----------------- end of code ---------------
