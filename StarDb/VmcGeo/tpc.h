...
//  printf("*** Building the Underwood version of the TPC ***\n");
  ...
  Char_t *InnerOuter[2] = {"Inner","Outer"};
  ...
  */
  ...
  for (sec = 0; sec < 2; sec++) {
    ...
    Double_t z  = (z1 + TPCG.MembTHK/2)/2;
    Double_t dz = (z1 - TPCG.MembTHK/2)/2;
