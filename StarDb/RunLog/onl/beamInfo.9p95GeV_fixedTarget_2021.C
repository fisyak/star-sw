...
memset(&row,0,tableSet->GetRowSize());
 ...
 memcpy(&row.yellowSpecies,"Au",2);// species  
    ...
    row.yellowEnergy	 =     9.95; // energy  ;
    row.yellowIntensity	 =       7.97; // Ions  ;
    row.yellowLifeTime	 =          0; // Ions per minute  ;
    row.yellowBunchIntensity	 =          0; // bunch intensity  ;
    row.blueFillNumber	 =      32240; // ;
    row.yellowFillNumber	 =      32240; // ;
tableSet->AddAt(&row);
// ----------------- end of code ---------------
