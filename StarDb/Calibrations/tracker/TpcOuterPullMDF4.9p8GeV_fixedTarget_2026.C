...
TDataSet *CreateTable() {
  ...
  row.nrows =  4; //pullYI	13p5GeV_fixedTarget_2026/pullYOGP2025_RF_13p5GeV_fixedTarget_2026GP.PullsH.root
  row.idx   =  1;//	Sigma
  row.DMean = 	1.568;
  ...
  memset(&row,0,tableSet->GetRowSize());
  row.nrows =  4; //pullZI	13p5GeV_fixedTarget_2026/pullZOGP2025_RF_13p5GeV_fixedTarget_2026GP.PullsH.root
  row.idx   =  3;//	Sigma
  row.DMean = 	3.527;;
