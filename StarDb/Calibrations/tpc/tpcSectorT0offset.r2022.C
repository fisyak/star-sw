...
TDataSet *CreateTable() { 
  ...
  Double_t Cosmic[24] = {-0.91,-1.09,-0.92, 0.00,-0.91,-0.93,-0.88,-0.87,-0.94, 0.00,-0.93,-0.93,
			 -0.89, 0.00,-0.89,-1.05,-1.01,-1.02,-0.92,-0.92,-0.88,-0.91,-0.93, 0.00};
  Double_t Cosmi2[24] = {-0.02,-0.04,-0.02, 0.07,-0.02,-0.02,-0.02,-0.02,-0.02, 0.05,-0.02,-0.02,
			 -0.02, 0.07,-0.02,-0.03,-0.02,-0.03,-0.02,-0.02,-0.02,-0.02,-0.02, 0.05};
  for (Int_t i = 24; i < 48; i++)  {row.t0[i] = -22.2572 -5.6122 - SAMPA[i-24] + Cosmic[i-24] + Cosmi2[i-24];} 
  tableSet->AddAt(&row);
  // ----------------- end of code ---------------
