#ifndef __CINT__
#include "tables/TpcResponseSimulator_Table.h"
#endif
...
//   row.SecRowCorIW[0] = row.SecRowCorIE[0] =  0.4595;
//   row.SecRowCorIW[1] = row.SecRowCorIE[1] = -5.40702e-04;
//   row.SecRowCorOW[0] = row.SecRowCorOE[0] =  0.89871;
//   row.SecRowCorOW[1] = row.SecRowCorOE[1] = -3.73511e-04;
  const Double_t RowMuTrs[8] = { 
    0.4595 + 0.17576, -5.40702e-04 - 0.001915889, // IW  0.1757558, -0.001915889
    0.8987 + 0.05861, -3.73511e-04 - 0.000996324, // OW 0.05860928, -0.0009963235
    0.4595 - 0.44009, -5.40702e-04 + 0.006894699, // IE -0.4400917, 0.006894699
    0.8987 - 0.25165, -3.73511e-04 + 0.001947534  // OE -0.2516514, 0.001947534
  };
  ...
  row.PolyaInner = 1.38;
  row.PolyaOuter = 1.38;
  row.T0offset   = 0.4127 ;//g // 01/18/12 Xianglei Zhu from Run 11 AuAu 27 & 19.6 GeV embedding 
  row.T0offsetI  = 0.0623 ; // TFG23a = 0
  row.T0offsetO  =-0.0870 ; // TFG23a = 0
