...
#else /* 05/15/2024 ZF */
  Double_t Cosmic_ZF[24] = { 0.26, 0.16, 0.19, 0.23, 0.22, 0.18, 0.19, 0.25, 0.21, 0.23, 0.23, 0.23, 
			     0.22, 0.19, 0.21, 0.25, 0.22, 0.16, 0.18, 0.24, 0.20, 0.19, 0.23, 0.26};
  for (Int_t i = 24; i < 48; i++)  {row.t0[i] = -22.2572 -7.0518 - SAMPA[i-24] + Cosmic_ZF[i-24] ;}
#endif
  tableSet->AddAt(&row);
  // ----------------- end of code ---------------
