...
TDataSet *CreateTable(const Char_t *theFile) {
  ...
  Double_t dT = 0;
  if      (nameP.Contains("14p5GeV_2019"))              dT = 0.04870 -0.02522-0.032 +0.048;// DEV2_newDB2/2019/RF/14p5GeV  ; // +/-  0.00001                                {"2019/RF/14p5GeV",                     -0.02522,  0.00018,    0.01891,  0.00021},    -0.032 2019/RF/14p5GeV     
  ...
  else if (nameP.Contains("7p7GeV_2019"))       	dT = 0.05043 -0.01024+0.000 -0.044;// DEV2_newDB2/2019/RF/7p7GeV  ; // +/-  0.00011 				      {"2019/RF/7p7GeV",                      -0.01024,  0.00034,    0.01659,  0.00033},    +0.000 2019/RF/7p7GeV      
  else if (nameP.Contains("9p2GeV_2019"))       	dT = 0.04042 -0.00987-0.000 -0.043;// DEV2_newDB2/2019/RF/9p2GeV  ; // +/-  0.00022 				      {"2019/RF/9p2GeV",     		      -0.00987,  0.00034,    0.01953,  0.00034},    -0.000 2019/RF/9p2GeV      
  else if (nameP.Contains("AuAu200_2019"))      	dT = 0.02828 -0.00664+0.000 -0.055;// DEV2_newDB2/2019/RF/AuAu200 ; // +/-  0.00007 				      {"2019/RF/AuAu200",    		      -0.00664,  0.00021,    0.01709,  0.00020},    +0.000 2019/RF/AuAu200     
  ...
  else if (nameP.Contains("7p7GeV_2020"))       	dT = 0.05646 -0.01041+0.005 -0.053;// DEV2_newDB2/2020/RF/7p7GeV   ; // +/-  0.00006 				      {"2020/RF/7p7GeV",                      -0.01041,  0.00028,    0.02407,  0.00035},    +0.005 2020/RF/7p7GeV      
  ...
  else if (nameP.Contains("9p2GeV_2020b"))       	dT = 0.04325 -0.03985-0.030 -0.033;// DEV2_newDB2/2020/RF/9p2GeVb ; // +/-  0.00003 				      {"2020/RF/9p2GeV",     		      -0.03985,  0.00032,    0.02100,  0.00041},    -0.030 2020/RF/9p2GeV      
  else if (nameP.Contains("9p2GeV_2020c"))       	dT = 0.04325 -0.03985-0.030 -0.032;// DEV2_newDB2/2020/RF/9p2GeVc ; // +/-  0.00003 				      {"2020/RF/9p2GeV",     		      -0.03985,  0.00032,    0.02100,  0.00041},    -0.030 2020/RF/9p2GeV      
  else if (nameP.Contains("9p2GeV_2020"))       	dT = 0.04325 -0.03985-0.030 -0.036;// DEV2_newDB2/2020/RF/9p2GeV  ; // +/-  0.00003 				      {"2020/RF/9p2GeV",     		      -0.03985,  0.00032,    0.02100,  0.00041},    -0.030 2020/RF/9p2GeV      
  ...
  else if (nameP.Contains("7p7GeV_2021"))              	dT = 0.04595 -0.01110-0.006 -0.054 -0.058;// DEV2_newDB2/2021/RF/7p7GeV_2021 ;// DEV2_newDB2/2021/FF/7p7GeV_2021  	; // +/-  0.00003 				      {"2021/RF/7p7GeV_2021",                 -0.01110,  0.00029,    0.02492,  0.00036},    -0.006 2021/RF/7p7GeV      
  else if (nameP.Contains("dAu200_2021"))              	dT = 0.05352 -0.01727+0.003 -0.040 -0.025;// DEV2_newDB2/2021/RF/dAu200_2021 ;// DEV2_newDB2/2021/FF/FF_OO_200GeV_2021; // +/-  0.00003 				      {"2021/RF/dAu200_2021",                 -0.01727,  0.00021,    0.01886,  0.00030},    +0.003 2021/RF/dAu200      
  else if (nameP.Contains("OO_200GeV_2021"))           	dT = 0.05647 -0.01381+0.000 -0.040;// DEV2_newDB2/2021/RF/OO_200GeV_2021  	 ; // +/-  0.00003 				      {"2021/RF/OO_200GeV_2021",              -0.01381,  0.00009,    0.01200,  0.00011},    +0.000 2021/RF/OO_200GeV   
  else if (nameP.Contains("ps_OO_200GeV_2021"))        	dT = 0.05627 -0.01377+0.000 -0.043;// DEV2_newDB2/2021/RF/ps_OO_200GeV_2021 ; // +/-  0.00002 				      {"2021/RF/ps_OO_200GeV_2021",           -0.01377,  0.00009,    0.01202,  0.00011},    +0.000 2021/RF/ps_OO_200GeV
