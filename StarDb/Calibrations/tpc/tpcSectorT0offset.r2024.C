...
#else /* 05/15/2024 RF + FF */
  Double_t Cosmic[24] = { 0.14, 0.03, 0.07, 0.11, 0.11, 0.05, 0.06, 0.12, 0.09, 0.11, 0.10, 0.10, 
			  0.08, 0.07, 0.09, 0.12, 0.09, 0.04, 0.06, 0.10, 0.08, 0.07, 0.09, 0.11};
  for (Int_t i = 24; i < 48; i++)  {row.t0[i] = -22.2572 -7.0518 - SAMPA[i-24] + Cosmic[i-24] ;}
#endif
  tableSet->AddAt(&row);
  // ----------------- end of code ---------------
