...
TDataSet *CreateTable() { 
  ...
  // SecRow3CGG8p65GeV_13p5GeV_fixedTarget_2026 FitP->Draw("sqrt(sigma**2-0.397108**2):y>>O(72,0.5,72.5)","i&&j&&y>40.5","sameprof")
  row.SecRowSigOW[0] =     0.494468;//   +/-   0.0159736   
  row.SecRowSigOW[1] =   -0.0101204;//   +/-   0.000584632 
  row.SecRowSigOW[2] =  8.57771e-05;//   +/-   5.25905e-06 

  row.SecRowSigOE[0] =     0.518895;//   +/-   0.0206962   
  row.SecRowSigOE[1] = 	 -0.0105375;//   +/-   0.000779823 
  row.SecRowSigOE[2] = 	9.23069e-05;//   +/-   7.23954e-06 
  //FitP->Draw("sqrt(sigma**2-0.414444**2):y>>IW(72,0.5,72.5)","i&&j&&y<40.5&&x<12.5","prof")
  row.SecRowSigIW[0] =     0.763356;//   +/-   0.00619156 
  row.SecRowSigIW[1] = 	 -0.0203333;//   +/-   0.000516791
  row.SecRowSigIW[2] = 	0.000257906;//   +/-   1.03574e-05
  // FitP->Draw("sqrt(sigma**2-0.414444**2):y>>IE(72,0.5,72.5)","i&&j&&y<40.5&&x>12.5","sameprof") 
  row.SecRowSigIE[0] =     0.660041;//   +/-   0.00309961 
  row.SecRowSigIE[1] =   -0.0154713;//   +/-   0.000328759
  row.SecRowSigIE[2] =  0.000137391;//   +/-   7.50605e-06
  row.PolyaInner = 1.38;
  row.PolyaOuter = 1.38;
