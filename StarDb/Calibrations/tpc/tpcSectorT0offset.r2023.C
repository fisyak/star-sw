...
TDataSet *CreateTable() { 
  ...
  Double_t Cosmi3[24] = { 0.02,-0.01,-0.01,-0.03,-0.01, 0.00,-0.00, 0.01,-0.01,-0.01,-0.06,-0.01,
			 -0.00,-0.14,-0.00, 0.00,-0.00,-0.20,-0.15,-0.21, 0.01, 0.01,-0.14,-0.02};
  Double_t Cosmi4[24] = { 0.00, 0.04, 0.04, 0.05, 0.05, 0.06, 0.04, 0.04, 0.04, 0.04, 0.04, 0.05, 
			  0.04, 0.04, 0.04, 0.05, 0.04, 0.04, 0.04, 0.04, 0.03, 0.05, 0.04, 0.04};
  for (Int_t i = 24; i < 48; i++)  {row.t0[i] = -22.2572 -6.67670 - SAMPA[i-24] + Cosmi2[i-24] + Cosmi3[i-24] + Cosmi4[i-24];}
  tableSet->AddAt(&row);
  // ----------------- end of code ---------------
