void Oleg(Double_t Z = 635, const Char_t *histName = "flux100keVn") {
  ...
  TFile *_file2 = TFile::Open("r2013G3/r2013G3.root");
  TFile *_file3 = TFile::Open("r2022VMC/r2022VMC.root");
  TFile *_file4 = TFile::Open("r2022G3/r2022G3.root");
  TFile *files[5] = {_file0, _file1,  _file2, _file3, _file4};
  const Char_t *tags[5] = {"2013G3old", "2013VMC", "2013G3", "2022VMC", "2022G3"};
  Int_t binX = -1;
